...
app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('DATABASE_URL','sqlite:///app.db')  #"postgresql://chitravihar_database_user:5L8PZ52f1fSrYREgBbpoah0W9619KoK9@dpg-cugt3i1u0jms73fqq2v0-a.singapore-postgres.render.com/chitravihar_database"   "sqlite:///app.db"
